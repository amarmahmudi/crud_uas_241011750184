...
@section('title', 'Tambah Pemain — Data Pemain Olahraga')
            ...
            <div class="glass-card rounded-2xl overflow-hidden animate-fade-in-up">
                ...
                <div class="px-6 sm:px-8 py-6 border-b border-white/5">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h1 class="text-xl font-bold text-white">Tambah Pemain Baru</h1>
                            <p class="text-sm text-slate-400">Isi form untuk menambahkan data pemain olahraga</p>
                        </div>
                    </div>
                </div>
