...
@section('title', 'Edit Pemain — Data Pemain Olahraga')
            ...
            <div class="glass-card rounded-2xl overflow-hidden animate-fade-in-up">
                ...
                <div class="px-6 sm:px-8 py-6 border-b border-white/5">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h1 class="text-xl font-bold text-white">Edit Data Pemain</h1>
                            <p class="text-sm text-slate-400">Perbarui informasi pemain <span class="text-white font-medium">{{ $pemain->nama_pemain }}</span></p>
                        </div>
                    </div>
                </div>
                ...
                <form method="POST" action="{{ route('admin.pemain.update', $pemain->id_pemain) }}" enctype="multipart/form-data" class="p-6 sm:p-8 space-y-6">
                        ...
                        <div class="flex items-start gap-4">
                            <div id="imagePreviewContainer"
                                ...
                                @if($pemain->gambar)
                                    ...
                                    <img id="imagePreview" src="{{ str_starts_with($pemain->gambar, 'data:') ? $pemain->gambar : asset('storage/' . $pemain->gambar) }}" alt="{{ $pemain->nama_pemain }}" class="w-full h-full object-cover">
                                @else
                    ...
                    <div>
                        <label for="nama_pemain" class="block text-sm font-medium text-slate-300 mb-2">
                            Nama Pemain <span class="text-red-400">*</span>
                        </label>
                        <input type="text"
                               id="nama_pemain"
                               name="nama_pemain"
